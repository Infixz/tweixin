...
import tmysql
_mysql = tmysql
from tmysql.constants import FIELD_TYPE
from tmysql.tests import base
from tmysql._compat import PY2, long_type
...
class TestDBAPISet(unittest.TestCase):
    def test_set_equality(self):
        self.assertTrue(tmysql.STRING == tmysql.STRING)

    def test_set_inequality(self):
        self.assertTrue(tmysql.STRING != tmysql.NUMBER)

    def test_set_equality_membership(self):
        self.assertTrue(FIELD_TYPE.VAR_STRING == tmysql.STRING)

    def test_set_inequality_membership(self):
        self.assertTrue(FIELD_TYPE.DATE != tmysql.STRING)
