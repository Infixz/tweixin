...
import tmysql.cursors

from tmysql.tests import base
from tmysql import util
from tmysql.err import ProgrammingError
...
class TestBulkInserts(base.PyMySQLTestCase):
    ...
    cursor_type = tmysql.cursors.DictCursor
...
age = values(age)"""))
    ...
    def test_warnings(self):
        ...
        self.assertEqual(ws[0].category, tmysql.Warning)
